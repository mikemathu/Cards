...
namespace Cards.Domain.Entities
{
    public class AppUser : IdentityUser
    {
        ...
        public ICollection<Card> Cards { get; } = []; //initializes the Cards property with an empty List<Card> when an instance of the AppUser entity is created. Hence Cards property is never null 
    }
}
